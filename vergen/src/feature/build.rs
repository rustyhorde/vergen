...
///
/// # Example
/// This feature can also be used in conjunction with the [`SOURCE_DATE_EPOCH`](https://reproducible-builds.org/docs/source-date-epoch/)
